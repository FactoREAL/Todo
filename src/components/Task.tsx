	...
	public render() {
		...
		return (
			<li key={task.id} className="list-group-item">
				...
				{task.title}
				<button className="btn btn-outline-danger btn-sm float-right mx-1" onClick={this.handleDelete}>
					<i className="fa fa-trash"/>
				</button>
				<button className="btn btn-outline-info btn-sm float-right mx-1" onClick={this.handleEdit}>
